...
<!-- Modal -->
<div id="modal" class="fixed inset-0 hidden flex items-center justify-center bg-opacity-50 transition-opacity duration-300 opacity-0 z-50">
  <div class="bg-white pb-6 rounded-sm max-w-md w-full mx-4 shadow-xl transform scale-95 transition-transform duration-300 relative max-h-md">
    ...
    <div class="px-6 lg:space-y-2">
      ...
      <div>
        ...
        <div class="bg-secondary text-primary px-4 py-2 mt-1 rounded-md text-sm">12Pcs (Rp. 100.000,00)</div>
      </div>
      ...
      <div>
        ...
        <div class="flex items-center gap-2 bg-secondary text-primary px-4 py-2 mt-1 rounded-md text-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-4" viewBox="0 0 448 512">
            <path fill="currentColor" d="M320 48a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zM204.5 121.3c-5.4-2.5-11.7-1.9-16.4 1.7l-40.9 30.7c-14.1 10.6-34.2 7.7-44.8-6.4s-7.7-34.2 6.4-44.8l40.9-30.7c23.7-17.8 55.3-21 82.1-8.4l90.4 42.5c29.1 13.7 36.8 51.6 15.2 75.5L299.1 224l97.4 0c30.3 0 53 27.7 47.1 57.4L415.4 422.3c-3.5 17.3-20.3 28.6-37.7 25.1s-28.6-20.3-25.1-37.7L377 288l-70.3 0c8.6 19.6 13.3 41.2 13.3 64c0 88.4-71.6 160-160 160S0 440.4 0 352s71.6-160 160-160c11.1 0 22 1.1 32.4 3.3l54.2-54.2-42.1-19.8zM160 448a96 96 0 1 0 0-192 96 96 0 1 0 0 192z"/>
          </svg>
          <span>Jln. Tibungsari 31 kuanji, Dalung</span>
        </div>
      </div>
      ...
      <div class="flex flex-col justify-center gap-2 mt-6">
        <a href="#" class="px-4 py-2 rounded-md bg-primary text-white text-center font-medium">Transaction</a>
        <button id="cancelModal" class="px-4 py-2 rounded-md bg-primary text-white font-medium cursor-pointer">Cancel Order</button>
      </div>
    </div>
  </div>
</div>
