...
<head>
    ...
    <title>Transaction Complete - HydroWash</title>
        ...
        <div class="px-[5%] flex justify-between items-center py-3">
            <div class="flex items-center gap-2">
                <h1 class="font-bold text-lg md:text-xl">
                    <a href="#">
                        Hydro<span class="text-white">Wash</span>
                    </a>
                </h1>
                <span class="bg-primary rounded-sm w-15 text-center text-sm md:text-base text-white">
                    complete
                </span>
            </div>
            <div class="flex items-center">
                <div class="bg-white text-black rounded-full h-8 w-8 flex items-center justify-center mr-2">
                    <span>MA</span>
                </div>
                <span class="text-white">Malvin</span>
