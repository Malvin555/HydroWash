                    ...
                    <div id="testimonialSlider" class="flex transition-transform duration-500 ease-in-out">
                        ...
                        <div class="w-full flex-shrink-0 px-4 md:px-12">
                            <div class="bg-white rounded-xl shadow-lg p-8">
                                <div class="grid grid-cols-1 md:flex md:items-center mb-6 gap-2">
                                    <div class="w-12 h-12 bg-primary rounded-full flex items-center justify-center text-white font-bold text-[.8rem]">
                                        S
                                    </div>
                                    <div>
