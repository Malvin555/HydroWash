<x-user-layout>
    ...
    <section class="min-h-screen bg-gradient-to-b from-white via-[#e6f7f9] to-[#d0f0f5] relative py-16 md:py-24">
        <div class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            <!-- Success Card -->
            <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden animate-fadeIn">
                <!-- Header -->
                ...
                <div class="p-6 md:p-8">
                    <div class="flex flex-col md:flex-row gap-8">
                        ...
                        <div class="md:w-1/3 flex justify-center">
                            <div class="relative">
                                <img src="{{ asset('img/complete-added.png') }}" alt="Service Added Successfully" class="w-48 h-auto mx-auto animate-float">
                        ...
                        <div class="md:w-2/3">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <div class="bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <p class="font-medium text-lg">lorem</p>
                                </div>
                                <div class="bg-gray-50 p-4 rounded-xl">
                                ...
                                <div class="bg-gray-50 p-4 rounded-xl">
                                    ...
                                    <p class="font-medium text-lg">#{{ str_pad(rand(1, 9999), 4, '0', STR_PAD_LEFT) }}</p>
                                </div>
                                <div class="bg-gray-50 p-4 rounded-xl">
                                    <span class="text-gray-500 text-sm block mb-1">Date:</span>
                                    <p class="font-medium text-lg">{{ now()->format('d M Y, H:i') }}</p>
                                </div>
                            </div>
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="mt-2 text-sm text-blue-700">
                                            <p>Please proceed to the payment page to complete your order. Your service will be processed once payment is confirmed.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <a href="{{ route('home') }}" class="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-3 px-6 rounded-xl transition-all duration-300 hover:shadow-md">
                                ...
                                <a href="{{ route('transaction', ['slug' => Str::slug('lorem')]) }}"  class="flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark text-white font-medium py-3 px-6 rounded-xl transition-all duration-300 hover:shadow-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="bg-gray-50 p-6 border-t border-gray-100 text-center">
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4 max-w-2xl mx-auto">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm text-gray-600">Estimated completion: <span class="font-medium">Estimation will be added after transaction</span></span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="bg-primary/10 p-2 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Order Summary Card -->
            <div class="mt-8 bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden animate-fadeIn animation-delay-300">
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-6">
                        <div class="md:w-2/3 space-y-4">
                            <div class="flex justify-between items-center pb-3 border-b border-gray-100">
                                ...
                                <span class="font-medium">Laundry</span>
                            </div>
                            <div class="flex justify-between items-center pb-3 border-b border-gray-100">
