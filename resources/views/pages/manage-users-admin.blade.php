<x-admin-layout>
    <div class="mb-6 flex items-center justify-between" data-module="manageUser">
        <div>
        ...
        <button data-modal-target="modalAddUser"
            data-fetch="false"
            class="bg-primary cursor-pointer text-white p-3 rounded-sm cursor-pointer">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="userList">
    ...
    <div id="pagination-container">
        {{ $users->links('pagination.history-user-pagination') }}
    </div>
