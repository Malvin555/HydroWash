<x-user-layout>
    ...
    @endphp
    <section class="min-h-screen bg-gradient-to-b from-white via-[#e6f7f9] to-[#d0f0f5] relative py-16 md:pt-16 md:pb-24">
        <div class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <!-- Success Message -->
            <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-6 relative z-10">
                <div class="bg-primary text-white p-6 text-center">
                    ...
                    <p>Your {{ $serviceType }} order has been successfully processed.</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <p class="font-medium">#{{ str_pad($data->id, 4, '0', STR_PAD_LEFT) }}</p>
                            </div>

                            <div class="mb-4">
                                <p class="text-gray-600 text-sm mb-1">Date & Time:</p>
                                <p>{{ \Carbon\Carbon::parse($data->created_at)->format('d M Y, H:i') }}</p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <div class="mb-4">
                                    ...
                                    <p>{{ \Carbon\Carbon::parse($model?->estimation)->format('d M Y') }} (1 Week)</p>
                                </div>
