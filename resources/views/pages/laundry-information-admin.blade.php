<!-- Modal -->
<div id="modalInformationLaundry"
            ...
            <form action="" method="" class="space-y-4">
                ...
                <div class="">
                    ...
                    <div class="bg-secondary rounded-md p-3 mt-4">
                        ...
                        <div class="mt-3 pt-2 border-t border-gray-200">
                            ...
                            <div class="flex justify-between items-center font-medium text-gray-600"
                                id="deliveryFeeRow-edit" style="display: flex;">
                ...
                <div>
                    ...
                    <input type="text" disabled
                        class="bg-secondary placeholder:text-primary px-4 py-2 w-full rounded-md outline-none text-sm"
                ...
                <div class="grid grid-cols-1 gap-2">
                    ...
                    <div class="flex items-start gap-2 bg-secondary text-primary px-4 py-2 mt-1 rounded-md text-sm">
                        ...
                        <input type="text" disabled name="address" id="address"
                            placeholder="Jln.Tibungsari 31 kuanji"
