<x-user-layout>
    ...
    <section class="h-full relative py-24">
        <div class="px-[5%]">
            <h1 class="text-center text-2xl md:text-4xl text-primary font-bold drop-shadow-[0_4px_1px_rgba(0,0,0,0.2)] mb-5">
                Ironing Service
            </h1>

            <form action="{{ route('laundry') }}" method="post" id="laundryForm">
                @csrf
