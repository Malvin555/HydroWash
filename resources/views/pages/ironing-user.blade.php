<x-user-layout>
    ...
    <section class="h-full relative py-24">
        <div class="px-[5%]">
            ...
            <h1
                class="text-center mt-3 text-2xl md:text-4xl text-primary font-bold drop-shadow-[0_4px_1px_rgba(0,0,0,0.2)] mb-5">
                Ironing Service</h1>
            <form action="{{ route('ironing') }}" method="post">
                ...
                <div class="flex gap-4 w-full overflow-x-auto scrollbar-hide">
                    ...
                    @if ($itemTypes->isnotEmpty())
                        @foreach ($itemTypes as $item)
                            <label class="cursor-pointer flex-shrink-0  transition-all duration-150 border-4 rounded-lg
                ...
                <div class="w-full mb-5">
                    ...
                    <textarea name="notes" id="notes" rows="10" class="w-full bg-secondary rounded-sm p-2"
