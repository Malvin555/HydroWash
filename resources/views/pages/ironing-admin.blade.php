<x-admin-layout>
        <div class="mb-6 flex items-center justify-between">
            ...
            <div>
                ...
                <button data-modal-target="modalAddIroning" class="bg-primary text-white p-2 rounded-sm cursor-pointer">
            ...
            <x-slot name="tbody">
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        ...
                        <button data-modal-target="modalInformationIroning" class="text-blue-500 hover:text-blue-700 cursor-pointer mr-3">
                        ...
                        <button data-modal-target="modalEditIroning" class="text-gray-500 hover:text-gray-700 cursor-pointer">
