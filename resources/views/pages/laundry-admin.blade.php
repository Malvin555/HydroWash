<x-admin-layout>
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="font-bold text-lg md:text-2xl">Manage Laundry</h1>
                <p class="text-black/50 text-[.8rem] md:text-base">Manage and respond to user reports.</p>
            </div>

            <div>
                <button id="" class="bg-primary text-white p-2 rounded-sm cursor-pointer">
                ...
                <button data-modal-target="modalAddLaundry" class="bg-primary text-white p-2 rounded-sm cursor-pointer">
        ...
        <x-table-admin>
            ...
            <x-slot name="tbody">
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-primary">Laundry #234</td>
                    <td class="px-6 py-4 text-sm text-primary">02-07-2025</td>
                    <td class="px-6 py-4 text-sm text-primary">Delivery</td>
                    <td class="px-6 py-4 text-sm text-primary">Clothes</td>
                    <td class="px-6 py-4">
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Completed</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <button data-modal-target="modalTransaction" class="cursor-pointer mr-3">
                            <img src="{{ asset('img/cash.svg') }}" alt="cash" class="w-5 h-5">
                        </button>
                        <button data-modal-target="modalInformationLaundry" class="text-blue-500 hover:text-blue-700 cursor-pointer mr-3">
                        ...
                        <button data-modal-target="modalEditLaundry" class="text-gray-500 hover:text-gray-700 cursor-pointer">
        ...
        @include('pages.modal-add-laundry')
        @include('pages.modal-edit-laundry')
        @include('pages.laundry-information-admin')
