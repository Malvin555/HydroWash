<x-admin-layout>
    <div class="mb-6 flex items-center justify-between" data-module="laundry">
        <div>
        ...
        <div>
            ...
            <button data-modal-target="modalAddLaundry" data-fetch="false"
                class="bg-primary text-white p-2 rounded-sm cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 md:w-7 md:h-7" fill="currentColor"
                    viewBox="0 0 448 512">
                    <path
    ...
    <x-table-admin>
        ...
        <x-slot name="tbody">
            <tbody class="bg-white divide-y divide-primary" id="laundryList">
                ...
                <tr @class([ 'line-through'=> $lndry->status_report === 'deleted',
                    ...
                    <td class="px-6 py-4 text-sm text-primary">
                        {{ ucfirst(str_replace('_', ' ', $lndry->retrieval_method)) }}</td>
                    <td class="px-6 py-4 text-sm text-primary">{{ $lndry->itemType->name_item }}</td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 flex items-center gap-2 text-sm text-gray-500">
                        ...
                        <button data-modal-target="modalEditLaundry" data-id="{{ $lndry->id }}"
        ...
        <x-slot name="pagination">
            <div id="pagination-container">
                {{ $laundry->links('pagination.table-pagination') }}
            </div>
        </x-slot>
    </x-table-admin>
