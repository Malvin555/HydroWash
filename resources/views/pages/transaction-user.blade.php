            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-8 border border-gray-100">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                    ...
                    <div class="mt-2 md:mt-0 bg-blue-50 text-blue-700 px-3 py-1 rounded-full text-sm font-medium">
                        Transaction ID: #{{ str_pad($transaction->id, 4, '0', STR_PAD_LEFT) }}
                    </div>
                </div>
                                                ...
                                                <div class="grid grid-cols-2 gap-4 mb-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="font-medium">Rp
                                                            {{ number_format($orderItem->itemType?->price_item ?? 0, 2, ',', '.') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="flex items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium capitalize">
                                            {{ $transaction->retrieval_method ?? old('retrieval-method') }}</p>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-1 space-y-8">
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100 sticky top-8">
                            ...
                            @php
                                ...
                                $subTotal =
                                    $transaction->retrieval_method === 'delivery' ? ($price - $deliveryFee) / 1.1 : $price;
                                $tax = $subTotal * 0.1;
                            @endphp
                            <div class="p-6">
                                <div class="space-y-4">
                                    ...
                                    @if ($transaction->retrieval_method === 'delivery')
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium">Rp
                                                {{ number_format($deliveryFee, 2, ',', '.') }}</span>
                                        </div>
                                        <div class="flex justify-between">
