            ...
            <form action="" method="" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" disabled
                        class="bg-secondary w-full placeholder:text-primary placeholder:font-bold px-4 py-2 mt-1 rounded-md text-sm outline-0"
                        placeholder="Ironing #234">
                </div>

                <div class="flex flex-col">
                    <label for="notes" class="text-sm font-bold text-primary mb-1">Fill Field</label>
                    <textarea name="notes" id="notes" disabled
                        placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
