            ...
            <div class="w-full flex flex-col gap-3">
                <div data-modal-target="modalInformationUser"
                    ...
                    <div class="flex flex-col items-end">
                        <h1
                            class="bg-btn w-[6rem] md:w-[60%] rounded-sm text-[#6D6969] text-[.8rem] font-bold py-1 px-4 text-center">
                            Pending
                        </h1>
                        <p class="text-[.6rem] md:text-sm flex items-center gap-1">
                ...
                <div data-modal-target="modalInformationUser"
                    ...
                    <div class="flex flex-col items-end">
                        <h1
                            class="bg-proccess w-[6rem] md:w-[60%] rounded-sm text-[#9F8D04] text-[.8rem] font-bold py-1 px-4 text-center">
                            Proccess
                        </h1>
                        <p class="text-[.6rem] md:text-sm flex items-center gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-2 h-2" viewBox="0 0 448 512">
                ...
                <div data-modal-target="modalInformationUser"
                    ...
                    <div class="flex flex-col items-end">
                        <h1
                            class="bg-success w-[6rem] md:w-[60%] rounded-sm text-[#399707] text-[.8rem] font-bold py-1 text-center">
                            Completed
                        </h1>
                        <p class="text-[.6rem] md:text-sm flex items-center gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-2 h-2" viewBox="0 0 448 512">
