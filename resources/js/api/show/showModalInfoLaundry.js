        ...
        <div class="space-y-4">
            ...
            <div class="">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <img src="${'/storage/' + data?.item_type?.image_item}" alt="image laundry">
                    <div class="flex flex-col gap-2 justify-between">
                        ...
                        <input type="text" disabled name="price_laundry" id="price_laundry" class="bg-secondary placeholder:text-primary px-4 py-2 w-full rounded-md outline-0" placeholder="${formatCurrency(data?.price_laundry)}">
