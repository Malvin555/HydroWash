                    ...
                    <div class="flex flex-col justify-between">
                        ...
                        <div class="relative inline-block w-full">
                            <select name="status-transaction" id="status-transaction"
                                ...
                                <option value="uncompleted" class="text-primary" ${data?.status_transaction === 'uncompleted' ? 'selected' : ''}>Uncompleted</option>
                                <option value="completed" class="text-primary" ${data?.status_transaction === 'completed' ? 'selected' : ''}>Completed</option>
                            </select>
